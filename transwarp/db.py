...
def create_engine(user, password, 
    database, host='127.0.0.1', port=3306, **kw):
    """
    ...
    engine = _Engine(
        lambda: mysql.connector.connect(**params))
    # test connection...
    logging.info('Init mysql engine <%s> ok.' % hex(
        id(engine)))
...
if __name__ == '__main__':
    ...
    create_engine('root', '123456', 'test', '127.0.0.1')
