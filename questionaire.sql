...
INSERT INTO `question` VALUES (7,'计算机科学界的最高奖项是以______命名的。','图灵 ;冯.诺依曼 ;比尔盖茨; 诺贝尔',0,'2017-07-13 23:24:27','2017-07-13 23:24:27','A',1,1,2),(9,'冯诺依曼体系结构是现代通用电子计算机的基础， 在这个结构中指出计算机中_______都是以二进制形式存储的。','程序和数据;程序和算法 ;指令与电流 ;数据与信息',0,'2017-07-13 23:24:27','2017-07-13 23:24:27','A',1,2,2),(10,'在计算机中，存储容量为1MB，指的是_____。','1024×1024位;1024×1024字节;1000×1000位 ;1000×1000字节',0,'2017-07-13 23:24:27','2017-07-13 23:24:27','B',1,1,2),(11,'在下列四个不同进制的无符号数中，值最大的是______。','(CB)16;(312)8; (204)10 ;(11001010)2\n',0,'2017-07-14 17:12:43','2017-07-14 17:12:43','C',1,2,2),(12,'可视范围内的两个山头上有四个醒目的土堆，每个土堆上可以立起或放倒一个醒目竖杆，这四个土堆上的竖杆能表达的消息总数________。\n','4;8;16;32\n',0,'2017-07-14 17:12:43','2017-07-14 17:12:43','C',1,1,2),(14,'有关半导体只读存储器(ROM)与半导体随机存储器（RAM）的描述，正确的是___________。\n','ROM可以永久保存信息，RAM在掉电后信息会丢失;RAM通常被用来制作移动硬盘;ROM掉电后，信息会丢失，RAM则不会;ROM是内存储器，RAM是外存储器',0,'2017-07-14 17:12:43','2017-07-14 17:12:43','A',1,2,2),(15,'不属于计算机外存设备的存储部件是_____。\n','高速缓存;磁盘阵列（RAID）;光驱;固态硬盘',0,'2017-07-14 17:12:43','2017-07-14 17:12:43','A',1,2,2),(16,'CPU可以直接访问计算机的______。\n','内存储器;硬盘;虚拟存储器;光盘',0,'2017-07-14 17:12:43','2017-07-14 17:12:43','C',1,3,2),(17,'CPU不能直接访问的存储器是______。\n','ROM;RAM ;Cache;CD－ROM',0,'2017-07-14 17:12:43','2017-07-14 17:12:43','C',1,3,2),(18,'在计算机存储器中，_____用来永久存放数据，不能随时修改。\n','虚拟存储器;RAM;ROM ;Cache',0,'2017-07-14 17:12:43','2017-07-14 17:12:43','C',1,3,2),(19,'关于内存与硬盘的区别，错误的说法是_______。\n','内存与硬盘都是存储设备;内存的容量小，硬盘的容量相对大;内存的存取速度快，硬盘的速度相对慢;断电后内存和硬盘中的信息仍然保留着',0,'2017-07-14 17:12:43','2017-07-14 17:12:43','C',1,2,2),(21,'程序设计语言可分为机器语言、____________和高级语言。\n\n','汇编语言;编程语言 ;排版语言 ;逻辑语言',0,'2017-07-14 17:12:43','2017-07-14 17:12:43','C',1,1,3),(22,'在程序设计语言中，C语言属于________。\n','机器语言;低级语言;高级语言;面向对象语言',0,'2017-07-14 17:54:34','2017-07-14 17:54:34','D',1,1,3),(23,'将计算机高级语言程序翻译为机器语言的程序是____________。\n','C语言程序; 编译程序;汇编程序;连接程序',0,'2017-07-14 17:54:34','2017-07-14 17:54:34','D',1,2,3),(24,'不是程序设计语言的是________。\n\n','Basic;Java;Python;Android',0,'2017-07-14 17:54:34','2017-07-14 17:54:34','C',1,1,3),(25,'设计算法的主要目的是________。\n\n','找出问题中的数学规律;提高计算机硬件的性能，比如加快CPU运行速度，提高内存或硬盘访问速度;使得程序易于被计算机理解\n;使得计算机能够在尽可能短的时间内正确完成计算任务',0,'2017-07-14 17:54:34','2017-07-14 17:54:34','C',1,2,3),(38,'121231414','124124;2423;4234234;24242',0,'2017-07-15 01:04:08','2017-07-15 01:04:08','C',1,1,2),(39,'1233','13123;12321;22432',0,'2017-07-15 01:09:17','2017-07-15 01:09:17','C',1,1,2),(40,'23424234','234234234',0,'2017-07-22 23:37:22','2017-07-22 23:37:22','C',1,1,3),(41,'132112312','1221;1232;12313',0,'2017-07-26 19:31:51','2017-07-26 19:31:51','C',1,1,3);
...
INSERT INTO `students` VALUES ('1601214588','qwrqwrr ','0048','东北',0,4,2,1,'2017-07-26 20:51:45');
...
-- Dump completed on 2017-07-26 21:26:08
